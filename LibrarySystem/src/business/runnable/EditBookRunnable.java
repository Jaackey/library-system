 ...
 * @author Jackey
 */
public class EditBookRunnable implements Runnable{
    ...
    public EditBookRunnable(Library library, String keyname, int newAmount, String newLocation){
...
//                int amount = sc.nextInt();
            ...
            Pattern pattern2 = Pattern.compile("[A-Z]\\d\\d-\\d\\d\\d");
            Matcher matcher2 = pattern2.matcher(newTemp);
            newTemp = matcher2.replaceFirst(newLocation);
